...
const PeopleNavigation = ({previousPage,nextPage,getRecourse, counterPage ,category})=>{
    ...
    return(
        ...
        <Link to={`/${category}/?page=${counterPage - 1}`} className={styles.link}>
        <UIButton
                    text="Previous"
...
/*
const PeopleNavigation = ({previousPage,nextPage,getRecourse, counterPage})=>{
